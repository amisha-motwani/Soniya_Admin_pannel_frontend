...
//         `${BASE_URL}/api/notes/fetchAll/${selectedValue}`,
//         {
//           method: "GET",
//           headers: headers,
//         }
...
//       // Update teamData state after deletion (optional)
//       const updatedTeamData = teamData.filter((member) => member.id !== id);
...
//                 className="text-red-600 text-[19px]"
//               />
//               <FontAwesomeIcon
//                 icon={faTrash}
